...
export class MyMigration1691586550779 implements MigrationInterface {
    name = 'MyMigration1691586550779'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "fullname" character varying NOT NULL, "email" TIMESTAMP NOT NULL, "password" integer NOT NULL, "picture" integer NOT NULL, "Deskript" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
